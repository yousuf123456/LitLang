...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex flex-col w-full rounded-md z-0 pt-16",
        className
      )}
    >
      <div className="relative flex w-full flex-1 items-center justify-center isolate z-0">
        <motion.div
          initial={{ width: "100%", maxWidth: "15rem" }}
          whileInView={{ width: "100%", maxWidth: "30rem" }}
          transition={{
            delay: 0.3,
            duration: 0.8,
            ease: "easeInOut",
        ...
        <motion.div
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-[#4b3f34] blur-2xl"
        ></motion.div>
        <motion.div
          initial={{ width: "100%", maxWidth: "15rem" }}
          whileInView={{ width: "100%", maxWidth: "30rem" }}
          ...
          className="absolute inset-auto z-50 h-0.5 w-[30rem] -translate-y-[7rem] bg-[#4b3f34]"
        ></motion.div>
