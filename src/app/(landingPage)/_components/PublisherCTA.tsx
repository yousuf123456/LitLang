...
export const PublisherCTA = () => {
  return (
    <div className="w-full relative mt-24 md:mt-36 px-3 sm:px-6 lg:px-12 py-16 md:py-24 bg-slate-900 overflow-hidden flex md:flex-row flex-col max-md:items-center md:justify-center gap-6 md:gap-12 lg:gap-24">
      <Boxes />
