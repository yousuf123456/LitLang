...
| ------------ | ------------ | ----------------------------------------------------------------- |
| **Frontend** | Next.js      | Full-stack React framework with built-in routing and SSR          |
|              | React        | UI library for building interactive components                    |
|              | Tailwind CSS | Utility-first CSS framework for custom styling                    |
|              | Shadcn UI    | Prebuilt modern components for consistent and clean UI            |
|              | Material UI  | Used specifically for data grid components                        |
| **Backend**  | MongoDB      | NoSQL database for storing and managing data                      |
|              | Auth0        | Authentication and authorization, limited to verified shop owners |
